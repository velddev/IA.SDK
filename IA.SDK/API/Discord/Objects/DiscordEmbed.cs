...
namespace Meru.SDK
{
    public class DiscordEmbed : IDiscordEmbed
    {
        ...
        public IDiscordEmbed CreateAuthor(string text, string iconUrl, string url) => throw new NotImplementedException();

        public IEmbedFooter CreateFooter() => throw new NotImplementedException();
